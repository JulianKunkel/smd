...
int main() {
  ...
  // SMD_DTYPE_UINT16
  {
    ...
    printf("\n\nSummary of UINT16 Conversions\n");

    i = 0;

    if (conv[i++] == 0)
      printf("\nThe conversion from uint_16 to int8_t was not possible!");
    else
      printf("\nThe conversion from uint_16 to int8_t was successull!");

    if (conv[i++] == 0)
      printf("\nThe conversion from uint_16 to int16_t was not possible!");
    else
      printf("\nThe conversion from uint_16 to int16_t was successull!");

    if (conv[i++] == 0)
      printf("\nThe conversion from uint_16 to int32_t was not possible!");
    else
      printf("\nThe conversion from uint_16 to int32_t was successull!");

    if (conv[i++] == 0)
      printf("\nThe conversion from uint_16 to int64_t was not possible!");
    else
      printf("\nThe conversion from uint_16 to int64_t was successull!");

    if (conv[i++] == 0)
      printf("\nThe conversion from uint_16 to uint8_t was not possible!");
    else
      printf("\nThe conversion from uint_16 to uint8_t was successull!");

    if (conv[i++] == 0)
      printf("\nThe conversion from uint_16 to uint16_t was not possible!");
    else
      printf("\nThe conversion from uint_16 to uint16_t was successull!");

    if (conv[i++] == 0)
      printf("\nThe conversion from uint_16 to uint32_t was not possible!");
    else
      printf("\nThe conversion from uint_16 to uint32_t was successull!");

    if (conv[i++] == 0)
      printf("\nThe conversion from uint_16 to uint64_t was not possible!");
    else
      printf("\nThe conversion from uint_16 to uint64_t was successull!");

    if (conv[i++] == 0)
      printf("\nThe conversion from uint_16 to float was not possible!");
    else
      printf("\nThe conversion from uint_16 to float was successull!");

    if (conv[i++] == 0)
      printf("\nThe conversion from uint_16 to double was not possible!");
    else
      printf("\nThe conversion from uint_16 to double was successull!");

    if (conv[i++] == 0)
      printf("\nThe conversion from uint_16 to char was not possible!\n\n");
    else

...
#define print_conversion(type, n, value)                                                              \
                                                                                                      \
...
printf("\nValue = %d", value[i]);                                                                     \
  ...
  j = 0;                                                                                              \
                                                                                                      \
  if (conv[j][i] == 0)                                                                                \
    printf("\nConversion from  "type"  to %8s \tNot possible!", types[j]);                            \
  else                                                                                                \
    printf("\nConversion from  "type"  to %8s \tSuccessull!", types[j]);                              \
                                                                                                      \
    j++;                                                                                              \
                                                                                                      \
  if (conv[j][i] == 0)                                                                                \
...
int main() {
  ...
  for (t = 0; t < n_int32; t++){
    printf("\n\nValue = %d", i32[t]);
    make_conversion(SMD_DTYPE_INT16, SMD_DTYPE_INT32, i16_, i32_, "%d", "%d", a, b, i32[t]);
  }
  ...
  for (t = 0; t < n_uint64; t++){
    printf("\n\nValue = %lu", ui64[t]);
    make_conversion(SMD_DTYPE_FLOAT, SMD_DTYPE_UINT64, f_, ui64_, "%f", "%lu", a, b, ui64[t]);
  }

...
int main() {
  ...
  // SMD_DTYPE_INT8
  {
...

    {
      ...
      attr1 = smd_attr_new_usertype(buff, SMD_DTYPE_INT8, SMD_DTYPE_INT8, &i8, id);
      if (attr1 == NULL) {
        conv[i++] = 0;
        ...
        printf("\nsmd_attr_new_usertype(int8_t, int8_t) = %d", i8);

        ret = smd_attr_copy_value_usertype(attr1, SMD_DTYPE_INT8, (void **)&i8_);
        if (ret) {
          printf("\nSorry... Something is really messed up!!! :(\n");
        }
        ret = smd_attr_copy_value_usertype(attr1, SMD_DTYPE_INT8, (void **)&d_);
        if (ret) {
          printf("\nSorry... Something is really messed up!!! :(\n");
        }
...

    {
      ...
      smd_attr_t *attr1 = smd_attr_new_usertype(buff, SMD_DTYPE_INT16, SMD_DTYPE_INT8, &i8, id);
      if (attr1 == NULL) {
        conv[i++] = 0;
        printf("\nSorry... It's not possible to make this conversion! :(\n");
      } else {
        ...
        printf("\nsmd_attr_new_usertype(int16_t, int8_t) = %d", i8);
...

    {
      ...
      smd_attr_t *attr1 = smd_attr_new_usertype(buff, SMD_DTYPE_INT32, SMD_DTYPE_INT8, &i8, id);
      if (attr1 == NULL) {
        conv[i++] = 0;
        printf("\nSorry... It's not possible to make this conversion! :(\n");
      } else {
        ...
        printf("\nsmd_attr_new_usertype(uint32_t, int8_t) = %d", i8);
...

    {
      ...
      smd_attr_t *attr1 = smd_attr_new_usertype(buff, SMD_DTYPE_INT64, SMD_DTYPE_INT8, &i8, id);
      if (attr1 == NULL) {
        conv[i++] = 0;
        printf("\nSorry... It's not possible to make this conversion! :(\n");
      } else {
        ...
        printf("\nsmd_attr_new_usertype(int64_t, int8_t) = %d", i8);
...

    {
      ...
      smd_attr_t *attr1 = smd_attr_new_usertype(buff, SMD_DTYPE_UINT8, SMD_DTYPE_INT8, &i8, id);
      if (attr1 == NULL) {
        conv[i++] = 0;
        printf("\nSorry... It's not possible to make this conversion! :(\n");
      } else {
        ...
        printf("\nsmd_attr_new_usertype(uint8_t, int8_t) = %d", i8);
...

    {
      ...
      smd_attr_t *attr1 = smd_attr_new_usertype(buff, SMD_DTYPE_UINT16, SMD_DTYPE_INT8, &i8, id);
      if (attr1 == NULL) {
        conv[i++] = 0;
        printf("\nSorry... It's not possible to make this conversion! :(\n");
      } else {
        ...
        printf("\nsmd_attr_new_usertype(uint16_t, int8_t) = %d", i8);
...

    {
      ...
      smd_attr_t *attr1 = smd_attr_new_usertype(buff, SMD_DTYPE_UINT32, SMD_DTYPE_INT8, &i8, id);
      if (attr1 == NULL) {
        conv[i++] = 0;
        printf("\nSorry... It's not possible to make this conversion! :(\n");
      } else {
...

    {
      ...
      smd_attr_t *attr1 = smd_attr_new_usertype(buff, SMD_DTYPE_UINT64, SMD_DTYPE_INT8, &i8, id);
      if (attr1 == NULL) {
        conv[i++] = 0;
        printf("\nSorry... It's not possible to make this conversion! :(\n");
      } else {
        ...
        printf("\nsmd_attr_new_usertype(uint64_t, int8_t) = %d", i8);
...

    {
      ...
      smd_attr_t *attr1 = smd_attr_new_usertype(buff, SMD_DTYPE_FLOAT, SMD_DTYPE_INT8, &i8, id);
      if (attr1 == NULL) {
        conv[i++] = 0;
        printf("\nSorry... It's not possible to make this conversion! :(\n");
      } else {
        ...
        printf("\nsmd_attr_new_usertype(float, int8_t) = %d", i8);
...

    {
      ...
      smd_attr_t *attr1 = smd_attr_new_usertype(buff, SMD_DTYPE_DOUBLE, SMD_DTYPE_INT8, &i8, id);
      if (attr1 == NULL) {
        conv[i++] = 0;
        printf("\nSorry... It's not possible to make this conversion! :(\n");
      } else {
        ...
        printf("\nsmd_attr_new_usertype(double, int8_t) = %d", i8);
...

    {
      ...
      smd_attr_t *attr1 = smd_attr_new_usertype(buff, SMD_DTYPE_CHAR, SMD_DTYPE_INT8, &i8, id);
      if (attr1 == NULL) {
        conv[i++] = 0;
        printf("\nSorry... It's not possible to make this conversion! :(\n");
      } else {
